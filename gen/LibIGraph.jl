...
function Base.propertynames(x::var"##Ctag#371", private::Bool = false)
...
function Base.propertynames(x::var"##Ctag#372", private::Bool = false)
...
function Base.getproperty(x::Ptr{igraph_attribute_record_t}, f::Symbol)
    ...
    f === :value && return Ptr{var"##Ctag#371"}(x + 16)
    f === :default_value && return Ptr{var"##Ctag#372"}(x + 24)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{var"##Ctag#368"}, f::Symbol)
    ...
    f === :adj && return Ptr{var"##Ctag#369"}(x + 0)
    f === :range && return Ptr{var"##Ctag#370"}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{igraph_vs_t}, f::Symbol)
    ...
    f === :data && return Ptr{var"##Ctag#368"}(x + 8)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{var"##Ctag#363"}, f::Symbol)
    ...
    f === :vecptr && return Ptr{Ptr{igraph_vector_int_t}}(x + 0)
    f === :incident && return Ptr{var"##Ctag#364"}(x + 0)
    f === :range && return Ptr{var"##Ctag#365"}(x + 0)
    f === :path && return Ptr{var"##Ctag#366"}(x + 0)
    f === :between && return Ptr{var"##Ctag#367"}(x + 0)
    return getfield(x, f)
end
...
function Base.getproperty(x::Ptr{igraph_es_t}, f::Symbol)
    ...
    f === :data && return Ptr{var"##Ctag#363"}(x + 8)
    return getfield(x, f)
end
...
@cenum var"##Ctag#358"::UInt32 begin
    IGRAPH_UNDIRECTED = 0
    IGRAPH_DIRECTED = 1
end

@cenum var"##Ctag#359"::UInt32 begin
    IGRAPH_NO_MULTIPLE = 0
    IGRAPH_MULTIPLE = 1
end

@cenum var"##Ctag#360"::UInt32 begin
...
@cenum var"##Ctag#361"::UInt32 begin
    IGRAPH_SIMPLE_SW = 0
    IGRAPH_LOOPS_SW = 1
    IGRAPH_MULTI_SW = 6
end
...
@cenum var"##Ctag#362"::UInt32 begin
...
# Skipping MacroDefinition: IGRAPH_EIT_END ( eit ) ( ( eit ) . pos >= ( eit ) . end )

# Skipping MacroDefinition: IGRAPH_EIT_GET ( eit ) ( igraph_int_t ) ( ( ( ( eit ) . type == IGRAPH_EIT_RANGE ) ? ( eit ) . pos : VECTOR ( * ( eit ) . vec ) [ ( eit ) . pos ] ) )
